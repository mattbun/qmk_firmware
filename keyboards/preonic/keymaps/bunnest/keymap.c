...
[_ESC] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, RGB_MOD, RGB_SAI, RGB_VAI, RGB_HUI, DM_REC2, DM_RSTP, DM_PLY2, _______, _______,
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_TAB] = LAYOUT_preonic_grid(
  KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,      KC_F10,     KC_EQL,
  _______, KC_F11,  KC_F12,  _______, _______, _______, _______, _______, _______, _______,    _______,    KC_DEL,
  KC_ESC,  _______, _______, _______, _______, _______, _______, _______, _______, KC_MS_BTN4, KC_MS_BTN3, KC_MS_BTN5,
